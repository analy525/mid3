...
double getPonderal(double mass, double height)
{
    /*
       ...
       double cuberoot = pow(info[i][2], oneThird);
       double ponderal = info[i][2] / cuberoot;
       */
    double oneThird = 1.0 / 3.0;
...
int unit_test()
{
    ...
    // double mass = 1.0;
    //   double height = 1.0;
    //  float array[2][3] = { {135.000000,  50.000000,   13.572088},
    //  {135.000000,  51.591574,   13.858594}};
    string name [2][4] = {
        {"mass       ", "height    ", "ponderal  ", "returned  "},
        { "----------", "----------", "----------", "----------"}
    };
...
//double mass = 1.0;
//double height = 1.0;
//  double ret = getPonderal(mass, height);
//return ret;
//
